...
const emailRateLimit = (req, res, next) => {
    ...
    if (timeSinceLastEmail < 60 * 1000) {
        // Si el tiempo transcurrido desde el último correo electrónico es menor a un minuto
        return res
            .status(429)
            .json({
                message:
                    'Demasiados correos electrónicos enviados en poco tiempo, intentalo de nuevo en un momento',
            });
    }
